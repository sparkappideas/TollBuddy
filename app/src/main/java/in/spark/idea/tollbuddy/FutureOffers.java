 ...
 * {@link FutureOffers.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FutureOffers#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FutureOffers extends Fragment {
    ...
    MaterialBetterSpinner spnVehTypes,spnJourneyTypes,spnFuelTypes;
    ...
    String[] mjourneyTypes = {"Single","Two Way"};
    String[] mfuelTypes = {"Petrol","Diesel"};
     ...
     * @return A new instance of fragment FutureOffers.
     */
    // TODO: Rename and change types and number of parameters
    public static FutureOffers newInstance(String param1, String param2) {
        FutureOffers fragment = new FutureOffers();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_future_offers, container, false);

        MobileAds.initialize(getActivity(), "ca-app-pub-4283164631469341~3129888273");
        AdView mBottomAdView = (AdView) v.findViewById(R.id.offerbottomBanner);
...
/*
        fromPlace = (PlaceAutocompleteFragment)
                getActivity().getFragmentManager().findFragmentById(R.id.trip_place_from);

        toPlace = (PlaceAutocompleteFragment)
                getActivity().getFragmentManager().findFragmentById(R.id.trip_place_to);


        spnVehTypes = (MaterialBetterSpinner )v.findViewById(R.id.spn_trip_veh_types);
        spnJourneyTypes = (MaterialBetterSpinner)v.findViewById(R.id.spn_trip_journey_type);
        spnFuelTypes = (MaterialBetterSpinner)v.findViewById(R.id.spn_trip_fuel_type);

        txtMileage = (EditText)v.findViewById(R.id.txtmileage);
        ...
        ArrayAdapter<String> arrayAdapter3 = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_dropdown_item_1line,mfuelTypes);
        spnFuelTypes.setAdapter(arrayAdapter3);
...
/*
        ...
        *//*
        ...
        Button btnSubmit = (Button)v.findViewById(R.id.btntripsubmit);
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(spnFuelTypes.getText().toString().isEmpty()){
                    Toast.makeText(getActivity(),"Please select Fuel Type!",Toast.LENGTH_LONG).show();
                    return;
                }

                if(txtMileage.getText().toString().isEmpty()){
                    Toast.makeText(getActivity(),"Please select Average Mileage!",Toast.LENGTH_LONG).show();
                    return;
                }
        ...
        pgLoading = (ProgressBar)v.findViewById(R.id.pgtriploadig);
*/
...
/*
    class getResp extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.length()>0) {
                Intent act = new Intent(getActivity(), TripResults.class);
//                act.putExtra("geo", s);
...
*/
    ...
    public void onDestroyView() {
        super.onDestroyView();
/*
        PlaceAutocompleteFragment f = (PlaceAutocompleteFragment) getActivity().getFragmentManager().findFragmentById(R.id.trip_place_from);
        if (f != null)
            getActivity().getFragmentManager().beginTransaction().remove(f).commit();


        PlaceAutocompleteFragment f1 = (PlaceAutocompleteFragment) getActivity().getFragmentManager().findFragmentById(R.id.trip_place_to);
        if (f1 != null)
